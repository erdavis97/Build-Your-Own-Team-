            ...
            ZStack {
                ...
                VStack {
                    CustomText(text: "Title (TBD)")
                        .padding(68)
                    NavigationLink("START GAME", destination: MovingBackground().navigationBarBackButtonHidden(true))
                ...
                Image("Skull Knight").resizable().frame(width: 300, height: 250, alignment: .topLeading).position(CGPoint(x: 370.0, y: 250.0))
